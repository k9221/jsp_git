...
%>
    <header class="header">
        <div class="image-container">
            ...
            <ul class="main_nav">    
                <li><a href="<%= request.getContextPath() %>/login.jsp">ABOUT US</a></li>
                <li><a href="<%= request.getContextPath() %>/login.jsp">CREATING A SPACE</a></li>
                <li><a href="<%= request.getContextPath() %>/login.jsp">REMODELING</a></li>
                <li><a href="<%= request.getContextPath() %>/login.jsp">OFFICE</a></li>
            </ul>
